...
> 日期：2026-09-03 | 状态：v0.2 定稿（P0-1/P0-2 修复集已收口 535d667，36 测试全绿，版本 0.2.0）（用户拍板：命名 dsh-context-maid、repo 在 my-plugins/、工具链 mjs+node --test、sweep aggressive 保留意见、新增 compact 模型用户可配 + 智能路由端点） | 前置调研：
